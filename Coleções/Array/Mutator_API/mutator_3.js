...
console.log(languages.splice(1, 1)); // removeu um elemento
console.log(languages.splice(1, 0, "C++", "C#")); // não removeu e add dois elementos
console.log(languages.splice(1, 2, "C")); // removeu dois e add um elemento
console.log(languages);
